...
class Config:
    def __init__(self) -> None:
        ...
        '''
        self.dataset = 'NDX100'
        self.npz_pwd = '/home/sunhaoyu/DGDRL/data2023/'+self.dataset+'/'+self.dataset+'.numpy.npz'
        self.csv_pwd = '/home/sunhaoyu/DGDRL/data2023/'+self.dataset+'/'+self.dataset+'.csv'
        self.relation_pwd = '/home/sunhaoyu/DGDRL/data2023/'+self.dataset+'/'+'relation2.pkl'
