result_path='/home/DGDRL/NAS/test2/'
class Config:
    def __init__(self) -> None:
        ...
        '''
        self.dataset = 'NAS'
        self.npz_pwd = '/home/DGDRL/data2023/'+self.dataset+'/'+self.dataset+'.numpy.npz'
        self.csv_pwd = '/home/DGDRL/data2023/'+self.dataset+'/'+self.dataset+'.csv'
        self.relation_pwd = '/home/DGDRL/data2023/'+self.dataset+'/'+'d_relation.pkl'
